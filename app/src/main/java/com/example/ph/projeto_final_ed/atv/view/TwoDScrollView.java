package com.example.ph.projeto_final_ed.atv.view;
...
public class TwoDScrollView extends FrameLayout {
    ...
    /**
     * The root to give focus to in the event that a root has requested focus while the
   ...
   */
   ...
   /* Offset from parent's local coordinates to TwoDScrollView coordinates */
    ...
    /**
     * Return true if root is an descendant of root, (or equal to the root).
     */
